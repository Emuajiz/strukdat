...
int main()
{
    ...
    while (1)
    {
        ...
        {
        case 1:
            cout << "proses print dari right->root->left:" << endl;
            bst.fun_4(root, 1);
            cout << endl;
            break;
        case 2:
            ...
            cout << "Ketik angka yang ingin dihapus dari BST: ";
            cin >> num;
            bst.fun_2(num);
            break;
        case 3:
            temp = new node;
            cout << "Ketik nilai yang ingin dimasukkan ke BST: ";
            cin >> temp->info;
            bst.fun_3(root, temp);
            break;
        case 4:
...
// case a kalau node tidak punya anak
...
// case b kalau node punya 1 anak aja
...
// case c kalau node punya 2 anak
